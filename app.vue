<template>
	<div>
		<Head>
			...
			<Meta property="og:description" content="The eighth generation of Durham University Computing Society's annual flagship hackathon." />
			<Meta property="og:image" content="/assets/splash2023.png" />
