  ...
  return (
    <div className="flex flex-col items-stretch justify-center h-screen bg-[#EB3DA2] max-h-screen relative overflow-hidden">
      ...
      <div className="flex-1 z-10 flex justify-center items-center">
        <h1 className={cn(audiowide.className, "text-white text-8xl font-bold")}>DurHack</h1>
      </div>
      ...
      <div className="flex-1 z-0 flex justify-center items-center w-full">
        <div className="relative w-full flex justify-center items-center translate-y-[20vh]">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[80%] w-[100vmax] h-auto aspect-square">
            <Image
