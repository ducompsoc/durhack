...
export function CvUploadBadge({ uploadedCv, className, ...props }: { uploadedCv: boolean } & React.ComponentProps<typeof Badge>): React.ReactNode {
  return <Badge variant="outline" className={cvUploadBadgeVariants({ uploadedCv, className })} {...props}>
