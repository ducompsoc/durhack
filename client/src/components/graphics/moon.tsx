  ...
  return (
    <div className={cn("relative aspect-square isolate", className)} {...props}>
      ...
      <div className="moon absolute w-full h-full">
        ...
        <div className="clip-circle moon-shadow" role="img" aria-label="an ethereal moon">
          <Image
          ...
          <svg viewBox="0 0 632 632" fill="none" className="absolute w-full h-full">
            <title>Highlights and shadows of the moon</title>
            <defs>
              <radialGradient
                id="moon-shadow"
                cx="0"
            ...
            <rect width="100%" height="100%" fill="url(#moon-shadow)" fillOpacity={0.25} />
            <rect width="100%" height="100%" fill="url(#moon-highlight)" fillOpacity={0.3} />
          </svg>
        </div>
      </div>
    </div>
