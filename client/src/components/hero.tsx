  ...
  return (
    ...
    >
      <div className="absolute h-full hidden 2xl:contents 2xl:w-full top-10">
        ...
        <Image
          src="/assets/graphics/sunflower.svg"
          alt="Sunflower"
          width={482}
          height={589}
        ...
        <Image
          src="/assets/graphics/windmill.svg"
          alt="Left Windmill"
          width={173}
          height={354}
        ...
        <Image
          src="/assets/graphics/dome-left.svg"
          alt="Left Dome"
          width={246}
          height={176}
        ...
        />
        <Image
          src="/assets/graphics/dome-right.svg"
          alt="Right Dome"
          width={453}
          height={316}
