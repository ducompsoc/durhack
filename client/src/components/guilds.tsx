    ...
    return (
        <div className="text-center px-28">
            ...
            <div className="text-center text-lg transition-opacity duration-500 ease-in-out opacity-100 p-4 text-size-4">
                ...
                <br/>
                <br/>
                Don't worry, you'll still make your project in a team of 4 - guilds are like a house system (think Harry Potter!).<br/>&nbsp;
            </div>

            <div className="container mx-auto ">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-16 w-full">
